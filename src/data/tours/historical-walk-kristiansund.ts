...
const tour: Tour = {
  ...
  subtitle: { no: "Løypa viser Kristiansunds utvikling som kystby, med klippfisk, handel og gjenoppbygging etter krigen.", en: "The route shows Kristiansund's development as a coastal town, with stockfish, trade, and reconstruction after the war." },
  description: { no: "Denne løypa viser hvordan Kristiansund har utviklet seg som kystby. Turistene får læres om klippfisk, handel og hvordan byen ble gjenoppbygd etter andres verdenskrig. Underveis opplever de både historie, kultur og natur.", en: "This route shows how Kristiansund has developed as a coastal town. Tourists learn about stockfish, trade, and how the town was rebuilt after the Second World War. Along the way, they experience history, culture, and nature." },
  howItWorks: { no: "1. Starter ved Kristiansund havn, hvor de fleste turistene ankommer.\n2. Herfra går turen gjennom sentrum med flere stopp som forteller om byens historie.\n3. Et av høydepunktene er Varden utsiktspunkt, hvor man får god utsikt over øyene og havet rundt byen.\n4. Turen avluttes ved Gripruta kai, som viser forbindelsen mellom byen og kysten.", en: "1.	Starts at Kristiansund harbor, where most tourists arrive.\n2.	From there, the route goes through the city center with several stops that tell the story of the town's history.\n3.	One of the highlights is the Varden viewpoint, where you get a great view of the islands and the surrounding sea.\n4.	The tour ends at the Gripruta quay, which shows the connection between the town and the coast." },
  estimatedTime: { no: "Ca. 1,5-2 timer", en: "Around 1,5-2 hours" },
  distance: "4km",
  difficulty: "moderat",
